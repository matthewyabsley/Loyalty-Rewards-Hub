...
interface DataContextValue {
  ...
  addTransaction: (tx: Omit<PointsTransaction, 'id'>) => void;
  toggleSavedItem: (item: MenuItem) => void;
  addPaymentMethod: (method: Omit<PaymentMethod, 'id'>) => void;
  removePaymentMethod: (methodId: string) => void;
  setDefaultPayment: (methodId: string) => void;
  markNotificationRead: (notifId: string) => void;
  markAllNotificationsRead: () => void;
  placeOrder: (items: CartItem[], tableNum: number) => void;
}
...
const SAMPLE_MENU: MenuItem[] = [
  {
    ...
    options: [
      { id: 'portion', label: 'Portion Size', required: true, choices: [{ id: 'regular', name: 'Regular', price: 0 }, { id: 'large', name: 'Large', price: 4.00 }] },
      { id: 'extras', label: 'Extra Toppings', choices: [{ id: 'truffle', name: 'Extra Truffle Shavings', price: 3.50 }, { id: 'parmesan', name: 'Extra Parmesan', price: 1.50 }, { id: 'mushroom', name: 'Wild Mushrooms', price: 2.50 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'cook', label: 'How would you like it cooked?', required: true, choices: [{ id: 'rare', name: 'Rare', price: 0 }, { id: 'medium-rare', name: 'Medium Rare', price: 0 }, { id: 'medium', name: 'Medium', price: 0 }, { id: 'well-done', name: 'Well Done', price: 0 }] },
      { id: 'side', label: 'Choose a Side', required: true, choices: [{ id: 'fries', name: 'Skin-on Fries', price: 0 }, { id: 'sweet-fries', name: 'Sweet Potato Fries', price: 1.50 }, { id: 'salad', name: 'Side Salad', price: 0 }, { id: 'onion-rings', name: 'Onion Rings', price: 1.00 }] },
      { id: 'extras', label: 'Add Extras', choices: [{ id: 'bacon', name: 'Smoked Bacon', price: 2.00 }, { id: 'cheese', name: 'Cheddar Cheese', price: 1.50 }, { id: 'egg', name: 'Fried Egg', price: 1.50 }, { id: 'avocado', name: 'Avocado', price: 2.00 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'portion', label: 'Portion Size', required: true, choices: [{ id: 'regular', name: 'Regular', price: 0 }, { id: 'large', name: 'Large', price: 3.00 }] },
      { id: 'extras', label: 'Add Extras', choices: [{ id: 'bread', name: 'Sourdough Bread', price: 2.00 }, { id: 'cream', name: 'Extra Cream', price: 1.00 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'protein', label: 'Add Protein', choices: [{ id: 'chicken', name: 'Grilled Chicken', price: 3.50 }, { id: 'prawns', name: 'King Prawns', price: 4.50 }, { id: 'salmon', name: 'Smoked Salmon', price: 5.00 }] },
      { id: 'extras', label: 'Extras', choices: [{ id: 'croutons', name: 'Extra Croutons', price: 1.00 }, { id: 'parmesan', name: 'Extra Parmesan', price: 1.50 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'side', label: 'Choose a Side', required: true, choices: [{ id: 'asparagus', name: 'Grilled Asparagus', price: 0 }, { id: 'mash', name: 'Creamy Mash', price: 0 }, { id: 'rice', name: 'Steamed Rice', price: 0 }] },
      { id: 'sauce', label: 'Sauce', choices: [{ id: 'dill', name: 'Lemon Dill (included)', price: 0 }, { id: 'hollandaise', name: 'Hollandaise', price: 1.50 }, { id: 'teriyaki', name: 'Teriyaki Glaze', price: 1.00 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'ice-cream', label: 'Ice Cream Flavour', required: true, choices: [{ id: 'vanilla', name: 'Vanilla Bean', price: 0 }, { id: 'salted-caramel', name: 'Salted Caramel', price: 0 }, { id: 'raspberry', name: 'Raspberry Sorbet', price: 0 }] },
      { id: 'extras', label: 'Add Extra', choices: [{ id: 'cream', name: 'Whipped Cream', price: 1.00 }, { id: 'berries', name: 'Fresh Berries', price: 2.00 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'portion', label: 'Portion', required: true, choices: [{ id: 'regular', name: 'Regular', price: 0 }, { id: 'sharing', name: 'Sharing (for 2)', price: 5.00 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'portion', label: 'Portion Size', required: true, choices: [{ id: 'regular', name: 'Regular', price: 0 }, { id: 'large', name: 'Large', price: 3.50 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'cook', label: 'How would you like it cooked?', required: true, choices: [{ id: 'rare', name: 'Rare', price: 0 }, { id: 'medium-rare', name: 'Medium Rare', price: 0 }, { id: 'medium', name: 'Medium', price: 0 }, { id: 'well-done', name: 'Well Done', price: 0 }] },
      { id: 'side', label: 'Choose a Side', required: true, choices: [{ id: 'fries', name: 'Triple-Cooked Chips', price: 0 }, { id: 'mash', name: 'Truffle Mash', price: 2.00 }, { id: 'salad', name: 'Rocket Salad', price: 0 }] },
      { id: 'sauce', label: 'Extra Sauce', choices: [{ id: 'bearnaise', name: 'B\u00e9arnaise', price: 1.50 }, { id: 'blue-cheese', name: 'Blue Cheese', price: 1.50 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'size', label: 'Size', required: true, choices: [{ id: 'regular', name: 'Regular', price: 0 }, { id: 'large', name: 'Large', price: 1.50 }] },
      { id: 'extras', label: 'Extras', choices: [{ id: 'ice', name: 'Extra Ice', price: 0 }, { id: 'mint', name: 'Fresh Mint', price: 0.50 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'style', label: 'Style', required: true, choices: [{ id: 'classic', name: 'Classic', price: 0 }, { id: 'vanilla', name: 'Vanilla', price: 1.00 }, { id: 'salted-caramel', name: 'Salted Caramel', price: 1.00 }] },
      { id: 'strength', label: 'Strength', choices: [{ id: 'single', name: 'Single Shot', price: 0 }, { id: 'double', name: 'Double Shot', price: 2.00 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'flavour', label: 'Flavour', required: true, choices: [{ id: 'vanilla', name: 'Classic Vanilla', price: 0 }, { id: 'lavender', name: 'Lavender', price: 1.00 }, { id: 'pistachio', name: 'Pistachio', price: 1.00 }] },
    ],
  },
];
...
const SAMPLE_ORDERS: Order[] = [
  { id: 'ord1', date: '2026-02-07T19:30:00', status: 'completed', tableNumber: 5, total: 72.47, items: [{ name: 'Wagyu Burger', quantity: 1, price: 30.49, options: ['Medium Rare', 'Sweet Potato Fries'] }, { name: 'Truffle Risotto', quantity: 1, price: 28.99, options: ['Large'] }, { name: 'Espresso Martini', quantity: 1, price: 12.99, options: ['Classic'] }] },
  { id: 'ord2', date: '2026-02-03T20:00:00', status: 'completed', tableNumber: 12, total: 48.97, items: [{ name: 'Pan-Seared Salmon', quantity: 1, price: 26.99, options: ['Grilled Asparagus'] }, { name: 'Caesar Salad', quantity: 1, price: 12.99 }, { name: 'Craft Lemonade', quantity: 1, price: 5.99, options: ['Large'] }] },
  { id: 'ord3', date: '2026-01-28T18:45:00', status: 'completed', tableNumber: 8, total: 58.97, items: [{ name: 'Grilled Ribeye', quantity: 1, price: 34.99, options: ['Medium', 'Triple-Cooked Chips'] }, { name: 'Lobster Bisque', quantity: 1, price: 14.99, options: ['Regular'] }, { name: 'Chocolate Fondant', quantity: 1, price: 11.99, options: ['Vanilla Bean'] }] },
  { id: 'ord4', date: '2026-01-20T13:00:00', status: 'completed', tableNumber: 3, total: 35.97, items: [{ name: 'Caesar Salad', quantity: 2, price: 25.98, options: ['Grilled Chicken'] }, { name: 'Tiramisu', quantity: 1, price: 10.99 }] },
];
...
export function DataProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const keys = ['bookings', 'rewards', 'transactions', 'orders', 'savedItems', 'paymentMethods', 'notifications'];
    const setters = [setBookings, setRewards, setTransactions, setOrders, setSavedItems, setPaymentMethods, setNotifications];
    keys.forEach((k, i) => {
      const d = localStorage.getItem(k);
      if (d) setters[i](JSON.parse(d));
    });
  }, []);

  function addToCart(item: MenuItem, options?: Record<string, { name: string; price: number }>, notes?: string) {
    setCart(prev => [...prev, { item, quantity: 1, cartId: genId(), selectedOptions: options, notes }]);
  }
  ...
  function addBooking(booking: Omit<Booking, 'id'>) {
    const updated = [{ ...booking, id: genId() }, ...bookings];
    setBookings(updated);
  ...
  function bookEvent(eventId: string) {
    setEvents(prev => prev.map(e => e.id === eventId ? { ...e, spotsLeft: Math.max(0, e.spotsLeft - 1) } : e));
  }

  function claimReward(rewardId: string) {
    const updated = rewards.map(r => r.id === rewardId ? { ...r, claimed: true } : r);
    setRewards(updated);
    save('rewards', updated);
  }

  function addTransaction(tx: Omit<PointsTransaction, 'id'>) {
    const updated = [{ ...tx, id: genId() }, ...transactions];
    setTransactions(updated);
    save('transactions', updated);
  }

  function toggleSavedItem(item: MenuItem) {
    ...
    if (existing) {
      ...
      updated = [{ id: genId(), menuItemId: item.id, name: item.name, description: item.description, price: item.price, category: item.category, savedDate: new Date().toISOString().split('T')[0] }, ...savedItems];
    }
    setSavedItems(updated);
    save('savedItems', updated);
  }

  function addPaymentMethod(method: Omit<PaymentMethod, 'id'>) {
    const updated = [...paymentMethods, { ...method, id: genId() }];
    setPaymentMethods(updated);
    save('paymentMethods', updated);
  }

  function removePaymentMethod(methodId: string) {
    const updated = paymentMethods.filter(p => p.id !== methodId);
    setPaymentMethods(updated);
    save('paymentMethods', updated);
  }

  function setDefaultPayment(methodId: string) {
    const updated = paymentMethods.map(p => ({ ...p, isDefault: p.id === methodId }));
    setPaymentMethods(updated);
    save('paymentMethods', updated);
  }
  ...
  function placeOrder(items: CartItem[], tableNum: number) {
    const order: Order = {
      id: genId(),
      ...
      items: items.map(c => ({
        name: c.item.name,
        quantity: c.quantity,
        price: (c.item.price + (c.selectedOptions ? Object.values(c.selectedOptions).reduce((s, o) => s + o.price, 0) : 0)) * c.quantity,
        options: c.selectedOptions ? Object.values(c.selectedOptions).map(o => o.name) : undefined,
      })),
    };
  ...
  return (
    <DataContext.Provider value={{
      menu: SAMPLE_MENU, cart, bookings, events, rewards, transactions, orders, savedItems, paymentMethods, notifications,
      tableNumber, setTableNumber, addToCart, removeFromCart, updateCartQuantity, clearCart, cartTotal,
      addBooking, cancelBooking, bookEvent, claimReward, addTransaction, toggleSavedItem,
      addPaymentMethod, removePaymentMethod, setDefaultPayment, markNotificationRead, markAllNotificationsRead, placeOrder,
    }}>
      {children}
